...
public class SelecionarAlunoProjeto extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelecionarAlunoProjeto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelecionarAlunoProjeto dialog = new SelecionarAlunoProjeto(new javax.swing.JFrame(), true);
